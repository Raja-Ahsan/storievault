...
const Contest = () => {
    ...
    return (
        <Layout headerClass="inner-header">
            ...
            <section className="py-100 " style={{ paddingTop: '140px', backgroundColor: '#F7EEE2' }}>
                <div className="container">
                    <div className="row mb-40">
                        <div className="col-12 text-center">
                            <h2 className="heading">Contests</h2>
                            <p className="fs-18">Participate in ongoing and past contests</p>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        {ongoingToShow.map((contest, idx) => (
                            <div key={`ongoing-${idx}`} className="col-12 mb-4 d-flex justify-content-center">
                                <Link href="/create-contest" className="text-decoration-none d-flex justify-content-center" style={{ width: '100%' }}>
                                    <div className="story-card cards rounded h-100 text-start" data-aos-duration="3000" data-aos="flip-left" style={{ position: 'relative', border: '2px solid #FEA257', padding: '18px', backgroundColor: '#FFF7E6', marginBottom: '40px', maxWidth: '900px', width: '100%' }}>
                                        ...
                                        <h5 className="fs-16 text-primary-theme text-capitalize mb-20 fw-600 pl-10">{contest.organizer || contest.author || 'Organizer'}</h5>
                            ...
                            return (
                                    <div key={`old-${idx}`} className="col-12 mb-4 d-flex justify-content-center">
                                       ...
                                       {/* <div className="mb-10 pl-10">
                                        ...
                                        <h5 className="fs-16 text-primary-theme text-capitalize mb-20 fw-600 pl-10">{author}</h5>
