              ...
              <CForm onSubmit={handleSubmit}>
                ...
                <CRow className="mb-3">
                  <CCol md={12}>
                    ...
                    <div className="form-text">
                      URL slug for the category page. Frontend link will be: /<strong>your-slug</strong>-stories
                    </div>
                  </CCol>
                </CRow>
                ...
                <CRow className="mb-3">
                  <CCol md={12}>
                    ...
                    <CFormTextarea
                      ...
                      rows={3}
                      placeholder="Short description for search results (e.g., Dive into the best adventure stories...)"
                ...
                <CRow className="mb-3">
                  <CCol md={12}>
                    ...
                    <div className="form-text">Rich text shown on the category page (e.g. Adventure stories) above the story list. Do not put FAQs here — use the section below.</div>
                  </CCol>
                </CRow>
